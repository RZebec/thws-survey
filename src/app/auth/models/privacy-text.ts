export function getPrivacyText(): string {
  return `<h4>Datenschutzerklärung</h4>

  <p>
    Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen. Datenschutz
    hat einen besonders hohen Stellenwert für die Geschäftsleitung der Robert
    Zebec. Eine Nutzung der Internetseiten der Robert Zebec ist
  ...
  <p>
    ...
    Übereinstimmung mit den für die Robert Zebec geltenden
  ...
  <p>
    Die Robert Zebec hat als für die Verarbeitung Verantwortlicher
  ...
  <p>
    Die Datenschutzerklärung der Robert Zebec beruht auf den
  ...
  <p>97080 Würzburg</p>
  <p>Deutschland</p>
  <p>Tel.: 004915222404481</p>
  <p>E-Mail: gZebec@runbox.com</p>
  <p>Website: fhws-study.vercel.app</p>

  <h4>3. Cookies</h4>
  <p>
    Die Internetseiten der Robert Zebec verwenden Cookies. Cookies sind
  ...
  <p>
    Durch den Einsatz von Cookies kann die Robert Zebec den Nutzern dieser
  ...
  <p>
    Die Internetseite der Robert Zebec erfasst mit jedem Aufruf der
  ...
  <p>
    ...
    Robert Zebec keine Rückschlüsse auf die betroffene Person. Diese
    ...
    erhobenen Daten und Informationen werden durch die Robert Zebec daher
  ...
  <p>
    ...
    Auftragsverarbeiter, beispielsweise einen Paketdienstleister, veranlassen,
    der die personenbezogenen Daten ebenfalls ausschließlich für eine interne
    Verwendung, die dem für die Verarbeitung Verantwortlichen zuzurechnen ist,
    nutzt.
  </p>
  ...
  <p>
    ...
    aufzuklären. Insofern ist die Speicherung dieser Daten zur Absicherung des
    für die Verarbeitung Verantwortlichen erforderlich. Eine Weitergabe dieser
  ...
  <p>
    ...
    über die betroffene Person gespeichert sind. Ferner berichtigt oder löscht
    der für die Verarbeitung Verantwortliche personenbezogene Daten auf Wunsch
    oder Hinweis der betroffenen Person, soweit dem keine gesetzlichen
  ...
  <ul style='list-style: none'>
    ...
    <li>
      ...
      <p>
        ...
        Person die Löschung von personenbezogenen Daten, die bei der Robert
        Zebec gespeichert sind, veranlassen möchte, kann sie sich hierzu
        jederzeit an einen Mitarbeiter des für die Verarbeitung
        Verantwortlichen wenden. Der Mitarbeiter der Robert Zebec wird
        veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
      </p>

      <p>
        Wurden die personenbezogenen Daten von der Robert Zebec öffentlich
        ...
        so trifft die Robert Zebec unter Berücksichtigung der verfügbaren
        ...
        die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Robert
        Zebec wird im Einzelfall das Notwendige veranlassen.
      </p>
    </li>
    <li>
      ...
      <p>
        ...
        bei der Robert Zebec gespeichert sind, verlangen möchte, kann sie
        sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
        Verantwortlichen wenden. Der Mitarbeiter der Robert Zebec wird die
    ...
    <li>
      ...
      <p>
        ...
        betroffene Person jederzeit an einen Mitarbeiter der Robert Zebec
        wenden.
      </p>
    </li>
    <li>
      ...
      <p>
        Die Robert Zebec verarbeitet die personenbezogenen Daten im Falle
      ...
      <p>
        Verarbeitet die Robert Zebec personenbezogene Daten, um
        ...
        Widerspricht die betroffene Person gegenüber der Robert Zebec der
        Verarbeitung für Zwecke der Direktwerbung, so wird die Robert Zebec
      ...
      <p>
        ...
        Verarbeitung personenbezogener Daten, die bei der Robert Zebec zu
      ...
      <p>
        ...
        Person direkt an jeden Mitarbeiter der Robert Zebec oder einen
    ...
    <li>
      ...
      <p>
        ...
        betroffenen Person, trifft die Robert Zebec angemessene Maßnahmen,
  ...
  <p>
    Entwickelt von den
    <a href='https://willing-able.com/'>Legal Tech</a> Spezialisten von
    Willing & Able, die auch das System für
    <a href='https://abletorecords.com/'
      >DS-GVO Datenschutz-Folgenabschätzungen</a
    >
    entwickelt haben. Die Texte des Datenschutzerklärungs-Generators wurden
    von
    <a href='https://dg-datenschutz.de/'
      >Prof. Dr. h.c. Heiko Jonny Maniero</a
    >
    und Rechtsanwalt
    <a href='https://www.wbs.legal/' rel='nofollow'>Christian Solmecke</a>
